...
BioKb-IPNI provides a command line interface (CLI) to import IPNI data into a relational database, create RDF turtles from it, and import the turtles into a Neo4J graph database.
